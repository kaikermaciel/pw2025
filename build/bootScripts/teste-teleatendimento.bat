...
set JARPATH=%APP_HOME%\lib\teste-teleatendimento-0.1.war

@rem Execute teste-teleatendimento
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TESTE_TELEATENDIMENTO_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TESTE_TELEATENDIMENTO_EXIT_CONSOLE%" exit 1
exit /b 1
